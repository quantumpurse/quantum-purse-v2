...
impl NodeManager {
    ...
    pub fn spendable_capacity(
        ...
        crate::tx_builder::spendable_capacity(self.rpc.as_ref(), from_address)
    }
    ...
    pub fn categorize_dao_cells(
        ...
        (
            Vec<crate::tx_builder::DepositedCell>,
            Vec<crate::tx_builder::PreparedCell>,
        ),
        NodeManagerError,
    > {
        crate::tx_builder::categozire_dao_cells(self.rpc.as_ref(), address)
    }
    ...
    pub fn fetch_quantum_lock_balance(
        ...
        fetch_quantum_lock_balance(self.rpc.as_ref(), lock_args_hex, self.config.network)
    }
    ...
    {
        crate::tx_builder::fetch_input_cells(self.rpc.as_ref(), tx)
    }
    ...
    pub fn send_transaction(
        ...
        crate::tx_builder::send_transaction(self.rpc.as_ref(), tx)
    }

    // ── Transaction builders ──────────────────────────────────────────

    /// Creates a transfer builder bound to this manager's RPC and network.
    pub fn transfer_builder(&self) -> crate::tx_builder::QpTransferBuilder<'_> {
        crate::tx_builder::QpTransferBuilder::new(self.rpc.as_ref(), self.is_mainnet())
    }

    /// Creates a DAO deposit builder bound to this manager's RPC and network.
    pub fn dao_deposit_builder(&self) -> crate::tx_builder::QpDaoDepositBuilder<'_> {
        crate::tx_builder::QpDaoDepositBuilder::new(self.rpc.as_ref(), self.is_mainnet())
    }

    /// Creates a DAO prepare builder bound to this manager's RPC and network.
    pub fn dao_prepare_builder(&self) -> crate::tx_builder::QpDaoPrepareBuilder<'_> {
        crate::tx_builder::QpDaoPrepareBuilder::new(self.rpc.as_ref(), self.is_mainnet())
    }

    /// Creates a DAO withdraw builder bound to this manager's RPC and network.
    pub fn dao_withdraw_builder(&self) -> crate::tx_builder::QpDaoWithdrawBuilder<'_> {
        crate::tx_builder::QpDaoWithdrawBuilder::new(self.rpc.as_ref(), self.is_mainnet())
    }
    ...
    pub fn connect_light_client(&self) -> Result<LightClientRpc, NodeManagerError> {
        connect_light_client(&self.config)
    }
}
