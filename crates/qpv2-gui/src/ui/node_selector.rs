                ...
                .show(ctx, |ui| {
                    egui::Frame::new()
                        ...
                        .show(ui, |ui| {
                            ...
                            for (ntype, icon, name, badge_text, badge_fill, accent_color) in
                                row_defs
                            {
                            ...
                            if commit_apply {
                                ...
                                let node_type_changed = self.temp_node_type != current.node_type;
                                ...
                                if network_changed || node_type_changed {
                                        ...
                                        && self.temp_node_type == NodeType::PublicRpc
                                    {
                                        self.settings_rpc_url =
                                            ckb_node::NodeConfig::default_rpc_url_for(
                                                self.temp_node_type,
                                                self.temp_network,
                                            )
                                            .to_string();
                                    ...
                                    // `local_node` with one bound to the new
                                        ...
                                        && self.temp_node_type == NodeType::LightClient
                                    {
                                        ...
                                        if let Err(e) =
                                            ckb_node::wallet_helpers::scripts::fetch_qr_lock_dep(
